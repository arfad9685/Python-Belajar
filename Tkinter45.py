...
def change_word(event = None):
    ...
    if editor.edit_modified():
        ...
        status_bars.config(text = "www.codershubb.com \t\t\t\t\t\t characters: {chararcter} words: {word}")
        #status_bars.config(text = "www.codershubb.com \t\t\t\t\t\t characters: {1} words: {0}" .format (chararcter, word)
