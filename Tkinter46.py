...
from tkinter import EXCEPTION, Label, ttk
...
def result (*args):
    ...
    if word:
        ...
        if mean_dict:
            ...
            label3['text'] = "we can't find any match for word => \n\ {word}"
...
search_btn = tk.Button(root,text="Search", bg='#8c52ff',fg='#ffffff', font=("Sitka Small",9),width=7,relief=tk.FLAT,command=result)
...
label3 = tk.Message(output_frame,width=250,font=("Sitka Small",8),justify=tk.LEFT,bg='#ffffff')
